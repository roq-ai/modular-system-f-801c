## Welcome to Modular system for business applications

Modular system for business applications is a B2B SaaS application that was generated using [ROQ.ai](https://roq.ai/)
